...
void Search(add*head)
{
    char ch[40];
     ...
     {
        system("cls");
        printf("\n\n\n\t\tNo Contact exists in this Phone Directory List!!!\n\n");
        return;
      }
      else
      {
...
void main()
{
    ...
    char c[40];
        ...
        printf("\n\t\t|!!!!!!!!!!!!!!!!! WELCOME TO OUR PHONE DIRECTORY !!!!!!!!!!!!!!!!!");
    ...
    while(1)
    {
        printf("\n\n\t\t\t\t\tMenu");
        printf("\n\t\t\t--------------------------------------------------");
        printf("\n\t\t\t1)Create A Contact\t\t2)Find a contact");
        printf("\n\t\t\t3)Show The Contact List\t\t4)Remove a contact");
        printf("\n\t\t\t-1)Quit");
        printf("\n\t\t\tEnter the choice:-");
        int ch;
        scanf("%d",&ch);
